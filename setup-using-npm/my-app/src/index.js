...
import React from "react";
import Men from "./state/update_state";
import Data from "./state/passing_argument_event_handler";
...
// Class Example
ReactDOM.render(<App name = "I am Your Props here" consumer ={true}/> , document.getElementById("root"));
